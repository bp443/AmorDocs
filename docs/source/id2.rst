...
3. Run ``sparse_convert.py`` script ot generate text file from hdf5. To launch on cluster, use the ``launch_1.ctrl`` file to submit after appropriate modifications.
